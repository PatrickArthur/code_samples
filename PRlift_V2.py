...
sx =raw_input("Select your Sex: M or F\n")
age=raw_input("What is your age in years\n")
wt=raw_input("What is your weight in lbs as of "+str(today)+"\n")
ht=raw_input("What is your height in inches as of "+str(today)+"\n")
wst=raw_input("What is your waist measurement in inches as of "+str(today)+"\n")
nk=raw_input("What is your neck measurement in inches as of "+str(today)+"\n")
hp=raw_input("For Females, what is your hip measurement in inches as of "+str(today)+"\n")
...
wt_per_ft=raw_input("PR Percentage: \n")
wt_per2_ft=((int(wt_per)*.01)/4)

lis=[]
lis2=[]

def test(exer,exer2,ls):
         excty=raw_input("Please add "+exer+str(Lastwk)+"\n")
         excty2=raw_input("Please add "+exer2+" as of "+str(Lastwk)+"\n")
         while (excty != ""):
                 ls.append([excty,excty2])
                 raw_input("Press <ENTER> to exit\n")
                 excty=raw_input("Please add "+exer+str(Lastwk)+"\n")
                 excty2=raw_input("Please add "+exer2+" as of "+str(Lastwk)+"\n")
test("exercises performed as of ","lbs lifted",lis)
test("miles ran ","time in mins/sec",lis2)

def test2(lss,ex1,ex2):
    for i in lss:
        var3=float(i[1])
...
test2(lis,"lift "," lbs as of ")
test2(lis2,"run "," in min/sec as of")
